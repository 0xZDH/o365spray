...
class Helper:
    ...
    def get_list_from_file(
        ...
        Arguments:
            ...
            skip_comments: if True, skip lines whose first non-whitespace
                character is '#'. Use for username files only. Must NOT be
                set for password files — '#' is a valid password character.
